      ...
      <View className="w-full px-10 justify-center py-20">
        ...
        <View className="flex flex-col gap-4 items-center justify-between self-center my-20 px-5">
          <View className="flex flex-row gap-4 items-center justify-between w-full">
            <View className="w-1/2 p-5 h-[130px] bg-[#78F3B5] rounded-xl flex flex-col justify-between">
              <View className="p-4 bg-white rounded-full max-w-[60px] w-10">
                <MaterialComunityIcons name="cart" size={20}  />
              </View>
            ...
            <View className="w-1/2 p-5 h-[130px] bg-[#00F279] rounded-xl flex flex-col justify-between">
