            ...
            <View className="h-full pt-10 px-5">
                ...
                <View className="h-[55%] mt-5">
                    ...
                    <View className="py-2">
                        ...
                        >
                            <Text
                                className="text-xl font-outfitSemiBold text-gray-800">{selectedInvoiceCustomer?.paymentStatus}</Text>
                        </View>
                    </View>
                    {/* List of Vendors */}
                    <View className="py-2">
                                ...
                                >
                                    <View className="flex flex-row gap-2 bg-slate-200 p-4 rounded-xl w-full">
                                        <View>
                                            ...
                                            <Text className="font-outfitRegular text-sm">Approval Status by Vendor
                                                : {item.approvalStatus}</Text>
                                        </View>
                ...
                {/* Action Buttons */}
                {
                    ...
                    <View className="flex flex-col gap-2 w-full mt-5 items-center">
                        <TouchableOpacity
                            className="bg-[#00F279] items-center justify-center px-8 py-3 rounded-full w-full"
                            onPress={handlePayment}>
                            <Text className="text-white text-xl font-bold">Pay Now!</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            className="bg-red-500 items-center justify-center px-8 py-3 rounded-full w-full">
