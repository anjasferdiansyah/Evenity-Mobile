    ...
    <View className="flex-1 relative items-center justify-center bg-white">
      <View className="w-full h-[85%]">
        ...
        <View>
          ...
          <View className="flex flex-row items-center justify-center gap-6 bg-gray-100 w-[90%] mx-auto rounded-xl mt-4 shadow-md blur-md">
            <Image
        ...
        <View className="mt-10 mx-auto bg-gray-100 w-[90%] rounded-xl shadow-md ">
          <View className="px-14">
            <View className="py-4 border-b border-white ">
                <TouchableOpacity className="flex flex-row gap-4 items-center" onPress={() => dispatch(logout())}>
          ...
          <Text className="text-xl text-red-500 font-outfitBold">
            ...
            <View className="py-4 border-b border-white ">
            <TouchableOpacity className="flex flex-row gap-4 items-center" onPress={() => router.push("/dashboard/profile/edit")}>
