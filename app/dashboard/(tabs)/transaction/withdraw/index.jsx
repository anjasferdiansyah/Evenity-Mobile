            ...
            <View className="w-full h-full pt-20 px-10">
                ...
                <View className="mt-14">
                    ...
                    <View className="flex flex-col gap-2">
                        ...
                        <View
                            className="py-2 px-4 rounded-xl text-xl font-outfitRegular border-[0.5px] border-gray-400">
                            <RNPickerSelect onValueChange={value => console.log(value)}
                                            useNativeAndroidPickerStyle={false} items={[
                ...
                <TouchableOpacity onPress={() => router.push('./final')}
