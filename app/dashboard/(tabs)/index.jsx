            ...
            <View className="w-full h-full px-10 justify-center">
                <View className="flex flex-row gap-4 justify-between px-5">
                    <View>
                        {userInfo?.detail && <Text className="text-6xl font-outfitBold">
                            Hi, <Text
                                className="text-[#00AA55]">{userInfo?.detail.fullName || userInfo?.detail.name}</Text>
                        </Text>}
                ...
                <View className="flex flex-col gap-4 items-center justify-between self-center my-8 px-5">
                    <View className="flex flex-row gap-4 items-center justify-between w-full">
                        ...
                        <ButtonListRequests onPress={() => router.push(ROUTES.DASHBOARD.REQUEST.INDEX)} role={role}/>
                    </View>
                    <View className="flex flex-row gap-4 items-center justify-between w-full">
                        <ButtonListTransactions onPress={() => router.push(ROUTES.DASHBOARD.TRANSACTION.INDEX)}/>
                        <ButtonSettingProfile onPress={() => router.push(ROUTES.DASHBOARD.PROFILE.INDEX)}/>
                    </View>
