        ...
        <View className="pt-10 flex-1 items-center justify-center bg-white">
            <View className="px-10 mt-4">
                ...
                <View className="flex flex-col gap-2">
                    <TouchableOpacity onPress={() => router.replace('auth/login')} className="bg-[#00AA55] mx-auto w-[60%] items-center justify-center px-8 py-3 rounded-full">
                    ...
                    <TouchableOpacity className="bg-[#00F279] mx-auto w-[60%] items-center justify-center px-8 py-3 rounded-full" onPress={() => router.push('auth/register')}>
                        <Text className="text-white text-xl font-outfitBold" >
                            Register
                        </Text>
                    </TouchableOpacity>
